...
if __name__ == "__main__":
    ...
    parser.add_argument('-med_domain', type=str)
    ...
    X_train_domain, X_train_task, Y_train_domain, Y_train_task, X_test_domain, X_test_task, Y_test_domain, Y_test_task = \
        load_task_data(task, med_domain, source_domains, check_on_test, data_size, seed)
    if estimate:
    ...
    res_file_dir = Path('results', task, f'{source_domains[0]}', med_domain, set_str,
